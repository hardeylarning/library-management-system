 ...
 * @author HARDEXICO
 */
public class EditStudentRecord extends javax.swing.JFrame {
Connection conn;
ResultSet rs;
...
Timestamp t = new Timestamp(System.currentTimeMillis());
    ...
    public EditStudentRecord() {
      ...
      public void update() {
        ...
        try {
           String sql="UPDATE Student SET Surname=? , Firstname=? , Dept=? , Faculty=? , Level=? , Phone_no=? , Address=? WHERE Matric_no=? ";
            ...
            pst.setString(8, matric.getText());
            pst.executeUpdate();
            pst.close();
            JOptionPane.showMessageDialog(this, "Account was successfully Updated");
               clear();
        }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 51, 51), 2, true), "Edit Student's Record", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(0, 0, 51))); // NOI18N
        ...
        setSize(new java.awt.Dimension(433, 483));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if((firstname.getText().length()<=3) || (matric.getText().length()<=3) || (surname.getText().length()<=3) ||
