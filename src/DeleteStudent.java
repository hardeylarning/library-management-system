...
PreparedStatement pst;
    ...
    public void setLimitation(){
           ...
           pst.close();
            if(i>=1){
                   JOptionPane.showMessageDialog(null, 
                           ...
                           + "because "+surname.getText()+" "+
                                   firstname.getText()+"is owing Library "
                           + i + " books\n Thank you. ");
               }
            else if((firstname.getText().length()<=2) || 
                    (matric.getText().length()<=3) || 
                    (surname.getText().length()<=2) ||
                    (phone.getText().length()<=6)){
                JOptionPane.showMessageDialog(this, 
                        "You can't delete Student records that doesn't exist");
            }
               else{
                   delete();
               }
      ...
      public void delete() {
        try {
            String sql="delete from Student where Matric_no=? ";
            pst = conn.prepareStatement(sql);
            pst.setString(1, matric.getText());
            pst.executeUpdate();
            pst.close();
            JOptionPane.showMessageDialog(this, "Student's Account was successfully deleted");
            clear();
        }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 51, 51), 2, true), "Delete Student's Account", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(0, 0, 51))); // NOI18N
        ...
        setSize(new java.awt.Dimension(383, 483));
