 ...
 * @author HARDEXICO
 */
public class CustomerRequestToReturnBook extends javax.swing.JFrame {
Connection conn;
ResultSet rs,catRs;
...
Login d = new Login();
 String user=d.userName;
    public CustomerRequestToReturnBook() {
    ...
    //Search by Name
     public void showBorrowedBook() {
        try {
            String sql="select Book_id,Book_name,Edition,Category,Issued_date,To_return_date from cstIssuedBook where Phone_no=?";
        pst=conn.prepareStatement(sql); 
            pst.setString(1, user);
            rs=pst.executeQuery();
...
//        String bookId="",name_of_book="",book_edition="",category="",issued_date="",to_return_date="";
        ...
        if(response==JOptionPane.YES_OPTION){
            //        pst=conn.prepareStatement(sql); 
            String sql="insert into cstRequestToReturnBook(Phone_no,Surname,Firstname,Address,Book_id,Book_name,Edition,Category,Issued_date,To_return_date,Request_date) values(?,?,?,?,?,?,?,?,?,?,?)";
        try {
             info();
            pst=conn.prepareStatement(sql);
            pst.setString(1, user);
            ...
            pst.setString(6, name_of_book);
            pst.setString(7, book_edition);
            ...
            String delete="delete from cstIssuedBook where Phone_no=? AND Book_id=? ";
