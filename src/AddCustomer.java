...
Timestamp t = new Timestamp(System.currentTimeMillis());
        ...
        try{
            ...
            pst=conn.prepareStatement(stfsql);
              ...
              rs=pst.executeQuery();
                ...
                else if((firstname.getText().length()<=3)|| (surname.getText().length()<=3) 
                        ||(occupation.getText().length()<=2) || 
                ...
                JOptionPane.showMessageDialog(this, "All the fields are required\n Please supply input. Thank you");
                        ...
                        String sql="insert into Account(Phone_no,Password,Surname,Firstname,Occupation,Address,Date) values(?,?,?,?,?,?,?)";
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 51, 51), 2, true), "Register New Customer", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(0, 0, 51))); // NOI18N
        ...
        setSize(new java.awt.Dimension(419, 400));
