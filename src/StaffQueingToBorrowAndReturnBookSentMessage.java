 ...
 * @author HARDEXICO
 */
public class StaffQueingToBorrowAndReturnBookSentMessage extends javax.swing.JFrame {
Connection conn;
...
//
    ...
    int to_return_date;
    String staff_id, surname, firstname, dept, title, phone, address, request_date;
    
    
    /**
     * Creates new form StudentQueingToBorrowAndReturnBook
     */
    public StaffQueingToBorrowAndReturnBookSentMessage() {
        initComponents();
    ...
    public void insertToBorrowReceivedMessage() {
        try {
            ...
            String insert = "insert into stfToBorrowReceivedMessage(Book_id,Book_name,Edition,";
                   insert+="Rack_no,Category,Staff_id,Surname,Firstname,Phone_no,Address,Message_time)";
                   insert+="values(?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public void toBorrowReceivedMessage() {
        try {
            String sql = "select * from stfToBorrowReceivedMessage ORDER BY Db_id DESC";
   ...
   //  To return receive message
    public void toReturnReceivedMessage() {
        try {
            String sql = "select * from stfToReturnReceivedMessage ORDER BY Db_id DESC";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jTable5.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Db Id", "Book_ID", "Book Name", "Edition", "Rack No", "Category", "Staff Id", "Surname", "Firstname", "Phone No", "Address", "Request Date", "Message Time"
            }
        ) {
        ...
        jTabbedPane1.addTab("Already Sent Message Staffs Requested to Borrow", jPanel5);
        ...
        jTable6.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Db_id", "Staff Id", "Surname", "Firstname", "Phone No", "Address", "Book Id", "Book Name", "Edition", "Category", "Issued Date", "To Return Date", "Request Date", "Message Time"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jTabbedPane1.addTab("Already Sent Message Staffs Requested to Return", jPanel6);
    ...
    private void jTable5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable5MouseClicked
        ...
        if (action == JOptionPane.YES_OPTION) {
            ...
            issueBook();
            Delete("stfToBorrowReceivedMessage");
            toBorrowReceivedMessage();
        }
    ...
    private void jTable6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable6MouseClicked
        ...
        if (action == JOptionPane.YES_OPTION) {
            ...
            Delete("stfToReturnReceivedMessage");
            toReturnReceivedMessage();
        }
