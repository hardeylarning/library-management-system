 ...
 * @author HARDEXICO
 */
public class EditStaffRecord extends javax.swing.JFrame {
Connection conn;
ResultSet rs;
PreparedStatement pst;
    ...
    public EditStaffRecord() {
      ...
      public void update() {
        ...
        try {
           String sql="UPDATE Staff SET Title=? , Surname=? , Firstname=? , Dept=?  , Phone_no=? , Address=? WHERE Staff_id=? ";
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 51, 51), 2, true), "Edit Staff's Record", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(0, 0, 51))); // NOI18N
        ...
        setSize(new java.awt.Dimension(391, 435));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if((firstname.getText().length()<=3) || (staff_id.getText().length()<=3) || (surname.getText().length()<=3) ||
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if(rs.next()) {
                ...
                dept.setText(add3);
                String add4=rs.getString("Title");
                title.setText(add4);
