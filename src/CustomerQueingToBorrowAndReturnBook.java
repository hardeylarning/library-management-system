 ...
 * @author HARDEXICO
 */
public class CustomerQueingToBorrowAndReturnBook extends javax.swing.JFrame {
 Connection conn;
...
//
    ...
    int to_return_date;
    String phone_no, surname, firstname, dept, title, phone, address, request_date,get_to_return_date,rack_no;
//    Sms sms = new Sms();
    /**
     * Creates new form StudentQueingToBorrowAndReturnBook
     */
    public CustomerQueingToBorrowAndReturnBook() {
        initComponents();
         conn = javaconnect.ConnectDb();
        cstRequestToBorrowBook();
        cstRequestToReturnBook();
    }
    //
     public void cstRequestToBorrowBook() {
        try {
            String sql = "select * from cstRequestToBorrowBook ORDER BY Db_id DESC ";
    ...
    public void insertToBorrowReceivedMessage() {
        try {
            ...
            String insert = "insert into cstToBorrowReceivedMessage(Book_id,Book_name,Edition,";
                   insert+="Rack_no,Category,Phone_no,Surname,Firstname,Address,Request_date,Message_time)";
                   insert+="values(?,?,?,?,?,?,?,?,?,?,?)";
    ...
    //Sent me
    //
    public void cstRequestToReturnBook() {
        try {
            String sql = "select * from cstRequestToReturnBook ORDER BY Db_id DESC ";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true), "Customers Queing to Borrow Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.BOTTOM, new java.awt.Font("Tahoma", 0, 22), new java.awt.Color(102, 0, 102))); // NOI18N
        ...
        borrow_table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Db Id", "Book_ID", "Book Name", "Edition", "Rack No", "Category", "Phone No", "Surname", "Firstname", "Address", "Request Date"
            }
        ));
        ...
        jTabbedPane1.addTab("Customers Queing to Borrow Details", jPanel1);

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true), "Customers Queing to Return Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.BOTTOM, new java.awt.Font("Tahoma", 0, 22), new java.awt.Color(0, 153, 153))); // NOI18N
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Db_id", "Phone No", "Surname", "Firstname", "Address", "Book Id", "Book Name", "Edition", "Category", "Issue Date", "To Return Date", "Request Date"
            }
        ) {
        ...
        jTabbedPane1.addTab("Customers Queing to Return Details", jPanel2);
    ...
    private void borrow_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_borrow_tableMouseClicked
        ...
        try{
            ...
            request_date = model.getValueAt(i, 10).toString();
        }
        catch (Exception e){
            JOptionPane.showMessageDialog(null, e);
        }
