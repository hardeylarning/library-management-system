...
PreparedStatement pst;
    ...
    public void delete() {
        ...
        try {
            String sql="delete from Account where Phone_no=? ";
            pst = conn.prepareStatement(sql);
            pst.setString(1, phone.getText());
            pst.executeUpdate();
            pst.close();
            JOptionPane.showMessageDialog(this, "Customer's Account was successfully deleted");
            clear();
        }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 51, 51), 2, true), "Delete Customer's Account", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(0, 0, 51))); // NOI18N
