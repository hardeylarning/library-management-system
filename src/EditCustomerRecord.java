 ...
 * @author HARDEXICO
 */
public class EditCustomerRecord extends javax.swing.JFrame {
Connection conn;
ResultSet rs;
PreparedStatement pst;
    ...
    public EditCustomerRecord() {
      ...
      public void update() {
        ...
        try {
           String sql="UPDATE Account SET Surname=? , Firstname=? , Occupation=? , Address=?, Phone_no=? WHERE Phone_no=? ";
            ...
            pst.executeUpdate();
            pst.close();
            JOptionPane.showMessageDialog(this, "Account has been successfully Updated");
               clear();
        }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 51, 51), 2, true), "Edit Customer's Record", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(0, 0, 51))); // NOI18N
        ...
        setSize(new java.awt.Dimension(387, 441));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if((firstname.getText().length()<=3) || (phone.getText().length()<=3) || (surname.getText().length()<=3) ||
