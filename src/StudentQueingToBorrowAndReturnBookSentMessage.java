 ...
 * @author HARDEXICO
 */
public class StudentQueingToBorrowAndReturnBookSentMessage extends javax.swing.JFrame {
Connection conn;
...
//
    ...
    int to_return_date;
    String matric, surname, firstname, dept, faculty, level, phone, address, request_date,get_to_return_date;
    
    
    /**
     * Creates new form StudentQueingToBorrowAndReturnBook
     */
    public StudentQueingToBorrowAndReturnBookSentMessage() {
        initComponents();
    ...
    public void insertToBorrowReceivedMessage() {
        try {
            ...
            String insert = "insert into stdToBorrowReceivedMessage(Book_id,Book_name,Edition,";
                   insert+="Rack_no,Category,Matric_no,Surname,Firstname,Phone_no,Address,Message_time)";
                   insert+="values(?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public void toBorrowReceivedMessage() {
        try {
            String sql = "select * from stdToBorrowReceivedMessage ORDER BY brm_id DESC";
   ...
   //  To return receive message
    public void toReturnReceivedMessage() {
        try {
            String sql = "select * from stdToReturnReceivedMessage ORDER BY rrm_id DESC";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
    ...
    public void returnBook() {
        ...
        try {
             ...
             String insert = "insert into stdReturnedBook(Matric_no,Surname,Firstname,Phone_no,Address,Book_id,";
    ...
    private void initComponents() {
        ...
        jTable5.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Db Id", "Book_ID", "Book Name", "Edition", "Rack No", "Category", "Matric No", "Surname", "Firstname", "Phone No", "Address", "Request Date", "Message Time"
            }
        ) {
        ...
        jTable6.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Db_id", "Matric No", "Surname", "Firstname", "Phone No", "Address", "Book Id", "Book Name", "Edition", "Category", "Issued Date", "To Return Date", "Request Date", "Message Time"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        if (jTable6.getColumnModel().getColumnCount() > 0) {
            ...
            jTable6.getColumnModel().getColumn(8).setPreferredWidth(10);
        }
    ...
    private void jTable5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable5MouseClicked
        ...
        if (action == JOptionPane.YES_OPTION) {
            ...
            issueBook();
            Delete("stdToBorrowReceivedMessage");
            toBorrowReceivedMessage();
        }
        }
        catch(Exception e){
    ...
    private void jTable6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable6MouseClicked
        ...
        if (action == JOptionPane.YES_OPTION) {
            ...
            Delete("stdToReturnReceivedMessage");
            toReturnReceivedMessage();
        }
        }
        catch(Exception e){
