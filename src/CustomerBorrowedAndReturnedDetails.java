 ...
 * @author HARDEXICO
 */
public class CustomerBorrowedAndReturnedDetails extends javax.swing.JFrame {
Connection conn;
...
int to_return_date;
String phone_no, surname, firstname, phone, address, request_date,rack_no;

    /**
     * Creates new form Statistics
     */
    public CustomerBorrowedAndReturnedDetails() {
        super("CUSTOMERS BORROWED AND RETURNED DETAILS");
        initComponents();
    ...
    public void Table1() {
        try {
            String sql="select * from cstIssuedBook ORDER BY Db_id DESC ";
    ...
    public void Table2() {
        try {
            String sql="select * from cstReturnedBook ORDER BY Db_id DESC";
        pst=conn.prepareStatement(sql);
        rs=pst.executeQuery();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Db Id", "Book ID", "Book Name", "Edition", "Category", "Phone No", "Surname", "Firstname", "Address", "Issued Date", "To Return Date"
            }
        ));
        ...
        jTabbedPane1.addTab("Customers Borrowed Details", jPanel1);
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Db Id", "Phone No", "Surname", "Firstname", "Address", "Book Id", "Book Name", "Edition", "Category", "Issued Date", "Returned Date"
            }
        ) {
        ...
        jTabbedPane1.addTab("Customers Returned Details", jPanel2);
        ...
        setSize(new java.awt.Dimension(1297, 711));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        phone_no = model.getValueAt(i, 5).toString();
...
//        String warning_message = "Dear " + surname + " " + firstname +" "+phone_no+" Just to remind you that " + "The Book " + book_name2 +" "+book_id2+ " "
...
//        String final_message="Dear " + surname + " " + firstname +" "+phone_no+" This is to inform you that " + " the Book " + book_name2 +" "+book_id2+ " "
