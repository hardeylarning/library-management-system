 ...
 * @author HARDEXICO
 */
public class StaffRequestToBorrowBook extends javax.swing.JFrame {
Connection conn;
ResultSet rs,catRs;
PreparedStatement pst,catPst;
    //
String surname,firstname,dept,title,phone_no,address,rack;
String book_id,book_name,edition,author,publisher,isbn,pages,request_date,category,availability;
Login d = new Login();
 String user=d.userName;
    public StaffRequestToBorrowBook() {
        super("BORROW BOOK");
        initComponents();
...
//        searchForBook();
    ...
    //Search by Name
     ...
     public void borrowBook(){
         try{
                String sql="insert into stfRequestToBorrowBook(Book_id,Book_name,Edition,Rack_no,Category,Staff_id,Surname,Firstname,Phone_no,";
                        sql+= "Address,Request_date) values(?,?,?,?,?,?,?,?,?,?,?)";
                pst=conn.prepareStatement(sql);
