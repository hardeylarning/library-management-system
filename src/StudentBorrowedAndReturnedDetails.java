 ...
 * @author HARDEXICO
 */
public class StudentBorrowedAndReturnedDetails extends javax.swing.JFrame {
Connection conn;
...
String matric, surname, firstname, dept, faculty, level, phone, address, request_date,get_to_return_date,rack_no;
     ...
     */
    public StudentBorrowedAndReturnedDetails() {
        super("STUDENTS BORROWED AND RETURNED DETAILS");
        initComponents();
    ...
    public void Table1() {
        try {
            String sql="select * from stdIssuedBook ORDER BY sib_id DESC ";
    ...
    public void Table2() {
        try {
            String sql="select * from stdReturnedBook ORDER BY srb_id DESC";
        pst=conn.prepareStatement(sql);
        rs=pst.executeQuery();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1352, 707));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Db Id", "Book ID", "Book Name", "Edition", "Category", "Matric No", "Surname", "Firstname", "Phone No", "Address", "Issued Date", "To Return Date"
            }
        ));
        ...
        jTabbedPane1.addTab("Students Borrowed Details", jPanel1);
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Db Id", "Matric No", "Surname", "Firstname", "Phone No", "Address", "Book Id", "Book Name", "Edition", "Category", "Issued Date", "Returned Date"
            }
        ) {
        ...
        jTabbedPane1.addTab("Students Returned Details", jPanel2);
        ...
        setSize(new java.awt.Dimension(1297, 712));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        matric = model.getValueAt(i, 5).toString();
...
//        String warning_message = "Dear " + surname + " " + firstname +" "+matric+" Just to remind you that " + "The Book " + book_name2 +" "+book_id2+ " "
...
//        String final_message="Dear " + surname + " " + firstname +" "+matric+" This is to inform you that " + " the Book " + book_name2 +" "+book_id2+ " "
